...
export function doLocalWhisper(audioFile: Blob, model = 'Xenova/whisper-tiny') {
...
export async function loadTranscriber(model = 'Xenova/whisper-tiny', timestamps: boolean, language: string): Promise<void> {
